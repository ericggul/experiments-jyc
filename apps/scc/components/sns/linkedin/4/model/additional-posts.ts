...
const egyptianPostImage = '/images/sns/linkedin/4/egyptian-register.png';
...
export const additionalPosts: Post[] = [
  ...
  },
  {
    ...
    body: 'A prototype shelf is not storage. It is a memory system for decisions that have not become language yet.\n\nWe relabelled ours by question instead of material: “Does it invite repair?”, “Where does the hand hesitate?”, “What gets louder after a week?” The failed pieces became much easier to revisit, and the team stopped treating them as waste.', media: egyptianPostImage, mediaType: 'image', reactions: 216, comments: 28, reposts: 14,
  },
  {
    ...
    media: egyptianPostImage, mediaType: 'image', reactions: 173, comments: 19, reposts: 8,
  },
  {
    ...
    body: 'We are opening applications for a six-month design engineer residency. The work is hands-on: build rough tools with local partners, take them into real routines, then return with evidence instead of a polished story.\n\nWe can support one resident who works primarily in Korean and English. Applications include a short account of something you changed after seeing it used.', media: egyptianPostImage, mediaType: 'image', reactions: 301, comments: 34, reposts: 22,
  },
  {
  ...
  },
  {
    ...
    media: egyptianPostImage, mediaType: 'image', reactions: 129, comments: 15, reposts: 11,
  },
  {
  ...
  },
  {
    ...
    body: 'Our summer open workshop starts next month. We are inviting designers, technicians, students, and people who simply have a stubborn repair problem to bring one object or one question.\n\nThere will be benches, basic hand tools, and short demonstrations on mould-making and low-volume casting. No portfolio required. The point is to make something testable before deciding it needs to be perfect.', media: egyptianPostImage, mediaType: 'image', reactions: 335, comments: 29, reposts: 25,
  },
  {
  ...
  },
  {
    ...
    body: 'We watched visitors use an audio guide prototype in a small gallery. Most did not want a continuous narration. They wanted permission to look first, then ask for context when curiosity arrived.\n\nThe revised flow begins silent and makes one sentence available at a time. It is a modest change, but it respects the pace of standing in front of an object with someone else nearby.', media: egyptianPostImage, mediaType: 'image', reactions: 406, comments: 54, reposts: 23,
  },
  {
  ...
  },
  {
    ...
    media: egyptianPostImage, mediaType: 'image', reactions: 822, comments: 91, reposts: 35,
  },
  {
    ...
    media: egyptianPostImage, mediaType: 'image', reactions: 367, comments: 44, reposts: 29,
  },
  {
  ...
  },
  {
    ...
    body: 'Applications are open for the Fieldroom Fellowship. We are looking for early-career practitioners working across product, architecture, public services, or community organising.\n\nThe fellowship offers desk space, a modest materials budget, peer critique, and time with local partners. Please apply with a question you cannot answer alone, rather than a finished project proposal.', media: egyptianPostImage, mediaType: 'image', reactions: 287, comments: 35, reposts: 46,
  },
  {
